  ...
  return (
    <section className="relative w-full h-screen bg-[#F6F6F2] px-6 overflow-hidden">
      ...
      <motion.code
        ...
        className=" absolute top-8 left-[5%] sm:left-[38%] transform hover:backdrop-blur-xl bg-white px-1 py-1 rounded text-[12px] sm:text-sm backdrop-blur z-10 text-[#4B5563] hover:bg-[#84A59D] hover:text-white"
      >
